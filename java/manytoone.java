 ...
 * @author 白一尼克
 */
public class manytoone extends javax.swing.JFrame {

    /**
     * Creates new form manytoone
     */
    public manytoone() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manytoone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
